...
export default async function OrganizationMonitoringPage({
  ...
  const monitoring = await getAgentUsageMonitoring(safeRange, organization.id);
  ...
  return (
    <PageLayout className="space-y-8">
      <PageLayoutHeader className="space-y-3 container mx-auto pt-10">
        <h1 className="text-3xl font-bold tracking-tight">
          Agent Usage Monitoring
        </h1>
        <p className="text-muted-foreground">
          Usage insights for {organization.name}.
        </p>
